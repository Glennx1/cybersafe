...
export interface TranslationDictionary {
  ...
  digitalArrest: {
    ...
    officialHelplinesTitle: string;
    nationalCyberHelpline: string;
    tollFree: string;
    citizenCyberDefense: string;
    cbiControlRoom: string;
    cbiAddress: string;
    edControlRoom: string;
    edAddress: string;
    backToLegalReality: string;
    downloadSec63BsaCert: string;
    bns204_308Tag: string;
    dotSancharSaathiTag: string;
    listenFactCheckAloud: string;
  };
  actions: {
    heroTitle: string;
    heroSubtitle: string;
  ...
  modals: {
    ...
    covertMerge: {
      ...
      discardBtn: string;
      importBtn: string;
      digitalArrestOption: string;
      digitalArrestSub: string;
...
const EN_DICT: TranslationDictionary = {
  common: {
    ...
    speaking: "Speaking...",
    footerCommand: "CyberRakshak 1930 // Dual-Engine Citizen Cyber Command",
    footerCompliance: "DPDP Act 2023 Compliant • On-Device Cryptographic Hashing • Sec 63 BSA Certified",
    step: "Step",
  ...
  audit: {
    ...
    vectorGoldenHourWarning: "Reported post-incident window. Lien request will target suspect bank mule nodes.",
  ...
  digitalArrest: {
    ...
    myth3Claim: "Transfer money to 'RBI Security Escrow' account for verification.",
    ...
    myth4Truth: "Under Article 22 of the Constitution and Sec 36 BNSS, consulting a lawyer is a fundamental right.",
    ...
    shareDigitalFirBtn: "Share FIR on WhatsApp",
    continueToSafetyBtn: "Continue to Safety Action",
    callerThreatDetailsTitle: "Caller & Threat Details",
    dropNoticeTitle: "Upload Suspicious Notice / Summons Image",
    dropNoticeSubtitle: "Forged CBI/Police letters or screenshots received on WhatsApp or Skype.",
    uploadDocumentBtn: "Upload Document",
    pasteDemandTitle: "Or Paste Message / Demand Text",
    pasteDemandPlaceholder: "Paste threat message e.g. 'You are placed under digital arrest by CBI for money laundering. Stay on Skype camera and deposit Rs 2,50,000...'",
    targetAgencyLabel: "Target Agency",
    demandLabel: "Demand",
    advisoryTitle: "Official Cyber Defense Advisory:",
    advisoryDesc: "Indian law enforcement agencies (CBI, State Police, ED, Customs, Supreme Court) NEVER arrest citizens over Skype or WhatsApp video calls and NEVER demand fund transfers to verification accounts. Do not transfer funds.",
    continueToReviewProof: "Continue to Review Proof",
    officialHelplinesTitle: "Official Verified Helplines & Numbers",
    nationalCyberHelpline: "National Cybercrime Helpline:",
    tollFree: "1930 (Toll Free)",
    citizenCyberDefense: "24x7 Citizen Cyber Defense",
    cbiControlRoom: "CBI Control Room:",
    cbiAddress: "HQ Lodhi Road, New Delhi",
    edControlRoom: "Enforcement Directorate (ED):",
    edAddress: "Headquarters, New Delhi",
    backToLegalReality: "Back to Legal Reality",
    downloadSec63BsaCert: "Download Sec 63 BSA Certificate",
    bns204_308Tag: "BNS Sec 204 & 308",
    dotSancharSaathiTag: "DoT Sanchar Saathi",
    listenFactCheckAloud: "Listen to Fact Check Aloud"
  },
  actions: {
    heroTitle: "Take Action Now — 1-Tap Direct Links",
    heroSubtitle: "Launch all emergency actions in one tap without manual copy-pasting.",
    ...
    step2BankDesc: "Sends pre-composed statutory lien request notice to:",
    step2BankBtn: "Email Bank",
    step3NcrpTitle: "File NCRP Complaint (cybercrime.gov.in)",
    step3NcrpDesc: "1-Tap copy statutory complaint statement & open official national portal.",
    step3NcrpCopyBtn: "1. Copy Legal Statement",
    step3NcrpPortalBtn: "2. Open cybercrime.gov.in",
    step4ShareTitle: "1-Tap WhatsApp & Document Sharing",
    livePrompterTitle: "Live Teleprompter Script (Read this to 1930 Officer):",
    collapseScript: "Hide Script",
    showScript: "Show Script",
    teleprompterHello: "Hello Officer, I need to report an emergency unauthorized cyber fraud of Rs. ",
    teleprompterClosing: "Please flag this UTR on CFCFRMS immediately to freeze the recipient account and provide me the acknowledgement number.",
    ...
    emailBankDesc: "Sends pre-composed statutory lien request notice to:",
    emailBankBtn: "Email Bank",
    downloadPdfAttachBtn: "Download PDF to Attach",
    noMailAppNotice: "Default mail app didn't open? Copy official fraud-desk email:",
    step3Tag: "Step 3 • Official Government Portal",
    step3Time: "Same-Day Filing",
    ncrpTitle: "File NCRP Complaint (cybercrime.gov.in)",
    ncrpDesc: "1-Tap copy statutory complaint statement & open official national portal.",
    copyStatementBtn: "1. Copy Legal Statement",
    statementCopiedBtn: "Statement Copied!",
    openPortalBtn: "2. Open cybercrime.gov.in",
    shareDocsTitle: "1-Tap WhatsApp & Document Sharing (Family, Lawyer, Police)",
    shareDocsSubtitle: "Directly share digitally compiled legal evidence PDFs.",
    docBankFreeze: "Bank Freeze Notice",
    docBankFreezeSub: "Section 91 BNSS Letter",
    docPoliceFir: "Police FIR",
    docPoliceFirSub: "BNS 318(4) Dossier",
    docCourtRefund: "Court Refund",
    docCourtRefundSub: "Section 503 BNSS Petition",
    docEvidenceCert: "Evidence Certificate",
    docEvidenceCertSub: "Section 63(4) BSA 2023"
  },
  a11y: {
    ...
    islTitle: "Sign language videos (preview — coming soon)",
    islDesc: "Displays preview slots for upcoming Indian Sign Language (ISL) explainer videos for Deaf and hard-of-hearing users."
  },
  modals: {
    auth: {
      loginTitle: "Access Your Saved Cases",
      registerTitle: "Create Citizen Account",
      subtitle: "All screenshots, bank records & queries link to this account",
      ...
      verifying: "Verifying...",
      createAccountBtn: "Create Account & Save Session",
      loginBtn: "Login & Link Case Sessions",
    ...
    covertMerge: {
      title: "Unsaved Covert Notes Found",
      subtitle: "Notes captured on this device during an emergency session",
      prompt: "We found notes captured during a covert session on this device. Would you like to start a case from them?",
      discardBtn: "Discard Notes",
      importBtn: "Import & Start Case",
      digitalArrestOption: "Extortion / Digital Arrest",
      digitalArrestSub: "Fake video calls & extortion",
      financialOption: "Financial Cyber Theft",
      financialSub: "UPI, bank, card fraud"
    },
    savedCases: {
      title: "Your Linked Incident Cases",
      subtitle: "Stored persistently in the database under your phone account",
      loading: "Loading your linked sessions from database...",
      emptyTitle: "No past cases recorded yet.",
      emptyDesc: "When you enter incident details or upload screenshots, they will automatically save to your account.",
      resumeBtn: "Resume Case"
    }
  }
};
...
const TE_DICT: TranslationDictionary = {
  common: {
    ...
    footerCommand: "సైబర్ రక్షక్ 1930 // డ్యూయల్-ఇంజన్ సిటిజన్ సైబర్ కమాండ్",
    footerCompliance: "DPDP చట్టం 2023 అనుకూలత • పరికరంలో క్రిప్టోగ్రాఫిక్ హ్యాషింగ్ • సెక్షన్ 63 BSA ధృవీకరించబడింది",
    step: "దశ",
  ...
  intake: {
    ...
    financialSubtitle: "మీ బ్యాంక్ డెబిట్ SMS లేదా UPI రసీదు స్క్రీన్‌షాట్‌ను (GPay / PhonePe / Paytm) అప్‌లోడ్ చేయండి లేదా కింద టెక్స్ట్ పేస్ట్ చేయండి.",
    ...
    pasteSmsPlaceholder: "డెబిట్ సందేశాన్ని పేస్ట్ చేయండి e.g. 'Debited Rs 85,500.00 via UPI Ref 312345678901 to VPA ramesh.traders@okaxis...'",
    utrLabel: "12-అంకెల బ్యాంకింగ్ UTR / RRN",
    amountLabel: "మోసం మొత్తం",
    serverVerified: "సర్వర్ ధృవీకరించబడింది"
  },
  audit: {
    scoreLabel: "స్కోరు",
    ...
    suspectIfscLabel: "అనుమానిత ఖాతా IFSC కోడ్",
    victimBankLabel: "బాధితుడి బ్యాంక్ పేరు",
    victimAccountNoLabel: "బాధితుడి ఖాతా సంఖ్య",
    victimIfscLabel: "బాధితుడి ఖాతా IFSC కోడ్",
    ...
    vectorRbiDetails: "కస్టమర్ నష్టం లేకుండా RBI మాస్టర్ డైరెక్షన్ DPSS.CO.PD.No.1417/02.14.006/2017-18 అమలు.",
    noticeCyberSafetyTitle: "సైబర్ భద్రతా చర్యలపై నోటీసు",
  ...
  step3Action: {
    ...
    whatNextTitle: "తర్వాత మీరు ఏమి చేయాలి? (సిఫార్సు చేసిన తదుపరి దశలు)",
  ...
  digitalArrest: {
    ...
    step3NextStepsSubtitle: "మిమ్మల్ని బెదిరించే మోసగాళ్లకు ఎటువంటి చట్టబద్ధమైన అధికారం లేదు. ఈ 3 రక్షణ దశలను అనుసరించండి మరియు అధికారిక నివేదికలను దాఖలు చేయండి.",
    safetyStep1Title: "1. అన్ని వీడియో కాల్‌లను కట్ చేసి కాలర్‌ను బ్లాక్ చేయండి",
    safetyStep1Desc: "వాట్సాప్ లేదా స్కైప్ వీడియో కాల్‌లను వెంటనే ముగించండి. నిజమైన పోలీసులు ఎప్పుడూ వెబ్‌క్యామ్‌లో పౌరులను బెదిరించరు.",
    ...
    safetyStep3Desc: "భారతీయ న్యాయ సంహిత (BNS) సెక్షన్ 204 (ప్రజా సేవకుడి వంచన) మరియు సెక్షన్ 308 (దోపిడీ) కింద క్రిమినల్ ఫిర్యాదును సిద్ధం చేయండి.",
    ...
    officialHelplinesTitle: "అధికారిక ధృవీకరించబడిన హెల్ప్‌లైన్‌లు & నంబర్లు",
    nationalCyberHelpline: "జాతీయ సైబర్ క్రైమ్ హెల్ప్‌లైన్:",
    tollFree: "1930 (టోల్ ఫ్రీ)",
    citizenCyberDefense: "24x7 పౌర సైబర్ రక్షణ",
    cbiControlRoom: "CBI కంట్రోల్ రూమ్:",
    cbiAddress: "ప్రధాన కార్యాలయం లోధి రోడ్, న్యూఢిల్లీ",
    edControlRoom: "ఎన్‌ఫోర్స్‌మెంట్ డైరెక్టరేట్ (ED):",
    edAddress: "ప్రధాన కార్యాలయం, న్యూఢిల్లీ",
    backToLegalReality: "చట్టపరమైన వాస్తవానికి తిరిగి వెళ్లండి",
    downloadSec63BsaCert: "సెక్షన్ 63 BSA ధృవీకరణ పత్రం డౌన్‌లోడ్ చేయండి",
    bns204_308Tag: "BNS సెక్షన్ 204 & 308",
    dotSancharSaathiTag: "DoT సంచార్ సాథి",
    listenFactCheckAloud: "వాస్తవాల తనిఖీని వినండి"
  },
  actions: {
  ...
  modals: {
    auth: {
      loginTitle: "మీ సేవ్ చేసిన కేసులను తెరవండి",
      registerTitle: "పౌర ఖాతాను సృష్టించండి",
      subtitle: "అన్ని స్క్రీన్‌షాట్‌లు, బ్యాంక్ రికార్డులు ఈ ఖాతాకు లింక్ చేయబడతాయి",
      demoAvailable: "డెమో ఖాతా అందుబాటులో ఉంది",
      fillCredentials: "వివరాలను పూరించండి",
      fullNameLabel: "పూర్తి పేరు",
      phoneLabel: "మొబైల్ ఫోన్ నంబర్",
      passwordLabel: "ఖాతా పాస్‌వర్డ్",
      verifying: "ధృవీకరిస్తోంది...",
      createAccountBtn: "ఖాతాను సృష్టించి సెషన్‌ను సేవ్ చేయండి",
      loginBtn: "లాగిన్ అయి కేసు సెషన్‌లను లింక్ చేయండి",
      alreadyHaveAccount: "ఇప్పటికే ఖాతా ఉందా?",
      needNewAccount: "కొత్త ఖాతా కావాలా?",
      signIn: "సైన్ ఇన్",
      register: "రిజిస్టర్"
    },
    covertMerge: {
      title: "సేవ్ చేయని రహస్య గమనికలు కనుగొనబడ్డాయి",
      subtitle: "అత్యవసర సెషన్ సమయంలో ఈ పరికరంలో రికార్డ్ చేసిన గమనికలు",
      prompt: "ఈ పరికరంలో రికార్డ్ చేయబడిన గమనికలు కనుగొనబడ్డాయి. వీటితో కొత్త కేసును ప్రారంభించాలనుకుంటున్నారా?",
      discardBtn: "గమనికలను తొలగించండి",
      importBtn: "దిగుమతి చేసి కేసు ప్రారంభించండి",
      digitalArrestOption: "దోపిడీ / డిజిటల్ అరెస్ట్",
      digitalArrestSub: "నకిలీ వీడియో కాల్స్ & దోపిడీ",
      financialOption: "ఆర్థిక సైబర్ దొంగతనం",
      financialSub: "UPI, బ్యాంక్, కార్డు మోసం"
    },
    savedCases: {
      title: "మీ లింక్ చేయబడిన సంఘటన కేసులు",
      subtitle: "మీ ఫోన్ ఖాతా కింద డేటాబేస్‌లో సురక్షితంగా నిల్వ చేయబడింది",
      loading: "డేటాబేస్ నుండి మీ సెషన్‌లు లోడ్ అవుతున్నాయి...",
      emptyTitle: "ఇంకా ఎటువంటి గత కేసులు నమోదు కాలేదు.",
      emptyDesc: "మీరు సంఘటన వివరాలను నమోదు చేసినప్పుడు లేదా స్క్రీన్‌షాట్‌లను అప్‌లోడ్ చేసినప్పుడు, అవి ఆటోమేటిక్‌గా మీ ఖాతాలో సేవ్ అవుతాయి.",
      resumeBtn: "కేసును పునఃప్రారంభించండి"
    }
  }
};
...
const HI_DICT: TranslationDictionary = {
  common: {
    ...
    speaking: "बोल रहा है...",
    footerCommand: "साइबर रक्षक 1930 // दोहरे इंजन नागरिक साइबर कमांड",
    footerCompliance: "DPDP अधिनियम 2023 अनुपालन • डिवाइस पर क्रिप्टोग्राफिक हैशिंग • धारा 63 BSA प्रमाणित",
    step: "चरण",
  ...
  intake: {
    ...
    pasteSmsPlaceholder: "डेबिट संदेश पेस्ट करें e.g. 'Debited Rs 85,500.00 via UPI Ref 312345678901 to VPA ramesh.traders@okaxis...'",
    utrLabel: "12-अंकों का बैंकिंग UTR / RRN",
    amountLabel: "धोखाधड़ी राशि",
    serverVerified: "सर्वर सत्यापित"
  },
  audit: {
    scoreLabel: "स्कोर",
  ...
  digitalArrest: {
    ...
    advisoryDesc: "भारतीय कानून प्रवर्तन एजेंसियां (CBI, राज्य पुलिस, ED, कस्टम्स, सुप्रीम कोर्ट) कभी भी वीडियो कॉल पर नागरिकों को गिरफ्तार नहीं करतीं और कभी भी सत्यापन खाते में पैसे ट्रांसफर करने की मांग नहीं करतीं। पैसे ट्रांसफर न करें।",
    continueToReviewProof: "साक्ष्य की समीक्षा के लिए आगे बढ़ें",
    officialHelplinesTitle: "आधिकारिक सत्यापित हेल्पलाइन और नंबर",
    nationalCyberHelpline: "राष्ट्रीय साइबर अपराध हेल्पलाइन:",
    tollFree: "1930 (टोल फ्री)",
    citizenCyberDefense: "24x7 नागरिक साइबर सुरक्षा",
    cbiControlRoom: "सीबीआई कंट्रोल रूम:",
    cbiAddress: "मुख्यालय लोधी रोड, नई दिल्ली",
    edControlRoom: "प्रवर्तन निदेशालय (ईडी):",
    edAddress: "मुख्यालय, नई दिल्ली",
    backToLegalReality: "कानूनी वास्तविकता पर वापस जाएं",
    downloadSec63BsaCert: "धारा 63 BSA प्रमाणपत्र डाउनलोड करें",
    bns204_308Tag: "BNS धारा 204 और 308",
    dotSancharSaathiTag: "दूरसंचार विभाग संचार साथी",
    listenFactCheckAloud: "तथ्य जांच बोलकर सुनें"
  },
  actions: {
    heroTitle: "अभी कार्रवाई करें — 1-टैप डायरेक्ट लिंक",
    heroSubtitle: "मैनुअल कॉपी-पेस्ट के बिना एक टैप में सभी आपातकालीन कार्रवाइयां शुरू करें।",
    step1HelplineTitle: "1930 हेल्पलाइन पर कॉल करें",
    ...
    step2BankDesc: "पूर्व-निर्मित संविधिक लीन अनुरोध नोटिस भेजता है:",
    step2BankBtn: "बैंक को ईमेल करें",
    step3NcrpTitle: "NCRP शिकायत दर्ज करें (cybercrime.gov.in)",
    step3NcrpDesc: "1-टैप कानूनी बयान कॉपी करें और आधिकारिक राष्ट्रीय पोर्टल खोलें।",
    step3NcrpCopyBtn: "1. कानूनी बयान कॉपी करें",
    step3NcrpPortalBtn: "2. cybercrime.gov.in खोलें",
    step4ShareTitle: "1-टैप व्हाट्सएप और दस्तावेज़ शेयरिंग",
    livePrompterTitle: "लाइव टेलीप्रॉम्प्टर स्क्रिप्ट (1930 अधिकारी को यह पढ़ें):",
    collapseScript: "स्क्रिप्ट छुपाएं",
    showScript: "स्क्रिप्ट दिखाएं",
    teleprompterHello: "नमस्ते अधिकारी महोदय, मुझे एक आपातकालीन अनधिकृत साइबर धोखाधड़ी की रिपोर्ट करनी है, राशि ₹",
    teleprompterClosing: "प्राप्तकर्ता खाते को फ्रीज करने के लिए कृपया CFCFRMS पर इस UTR को तुरंत फ्लैग करें और मुझे पावती संख्या प्रदान करें।",
    step1Tag: "चरण 1 • तत्काल प्राथमिकता",
    step1Time: "पहले 15 मिनट",
    call1930NowBtn: "अभी 1930 पर कॉल करें",
    step2Tag: "चरण 2 • अंतर-बैंक स्थानांतरण रोकें",
    step2Time: "15 मिनट – 2 घंटे",
    emailBankTitle: "बैंक फ्रॉड डेस्क को ईमेल करें (धारा 91 BNSS)",
    emailBankDesc: "पूर्व-निर्मित संविधिक लीन अनुरोध नोटिस भेजता है:",
    emailBankBtn: "बैंक को ईमेल करें",
    downloadPdfAttachBtn: "संलग्न करने के लिए पीडीएफ डाउनलोड करें",
    noMailAppNotice: "डिफ़ॉल्ट मेल ऐप नहीं खुला? आधिकारिक फ्रॉड-डेस्क ईमेल कॉपी करें:",
    step3Tag: "चरण 3 • आधिकारिक सरकारी पोर्टल",
    step3Time: "उसी दिन फाइलिंग",
    ncrpTitle: "NCRP शिकायत दर्ज करें (cybercrime.gov.in)",
    ncrpDesc: "1-टैप कानूनी बयान कॉपी करें और आधिकारिक राष्ट्रीय पोर्टल खोलें।",
    copyStatementBtn: "1. कानूनी बयान कॉपी करें",
    statementCopiedBtn: "बयान कॉपी हो गया!",
    openPortalBtn: "2. cybercrime.gov.in खोलें",
    shareDocsTitle: "1-टैप व्हाट्सएप और दस्तावेज़ शेयरिंग (परिवार, वकील, पुलिस)",
    shareDocsSubtitle: "डिजिटल रूप से संकलित कानूनी साक्ष्य पीडीएफ सीधे साझा करें।",
    ...
    docCourtRefund: "अदालत रिफंड",
    docCourtRefundSub: "धारा 503 BNSS याचिका",
    docEvidenceCert: "साक्ष्य प्रमाणपत्र",
  ...
  modals: {
    auth: {
      loginTitle: "अपने सहेजे गए मामलों तक पहुंचें",
      registerTitle: "नागरिक खाता बनाएं",
      subtitle: "सभी स्क्रीनशॉट, बैंक रिकॉर्ड और प्रश्न इस खाते से जुड़ते हैं",
      demoAvailable: "डेमो खाता उपलब्ध है",
      fillCredentials: "विवरण भरें",
      fullNameLabel: "पूरा नाम",
      phoneLabel: "मोबाइल फोन नंबर",
      passwordLabel: "खाता पासवर्ड",
      verifying: "सत्यापित किया जा रहा है...",
      createAccountBtn: "खाता बनाएं और सत्र सहेजें",
      loginBtn: "लॉगिन करें और केस सत्र लिंक करें",
    ...
    covertMerge: {
      title: "असुरक्षित गुप्त नोट्स मिले",
      subtitle: "आपातकालीन सत्र के दौरान इस डिवाइस पर कैप्चर किए गए नोट्स",
      prompt: "इस डिवाइस पर एक गुप्त सत्र के दौरान रिकॉर्ड किए गए नोट्स मिले हैं। क्या आप उनसे एक नया केस शुरू करना चाहते हैं?",
      discardBtn: "नोट्स हटाएं",
      importBtn: "आयात करें और केस शुरू करें",
      digitalArrestOption: "जबरन वसूली / डिजिटल अरेस्ट",
      digitalArrestSub: "फर्जी वीडियो कॉल और जबरन वसूली",
      financialOption: "वित्तीय साइबर चोरी",
      financialSub: "UPI, बैंक, कार्ड धोखाधड़ी"
    },
    savedCases: {
      title: "आपके लिंक किए गए घटना मामले",
      subtitle: "आपके फोन खाते के तहत डेटाबेस में सुरक्षित रूप से संग्रहीत",
      loading: "डेटाबेस से आपके लिंक किए गए सत्र लोड हो रहे हैं...",
      emptyTitle: "अभी तक कोई पिछला मामला दर्ज नहीं है।",
      emptyDesc: "जब आप घटना का विवरण दर्ज करते हैं या स्क्रीनशॉट अपलोड करते हैं, तो वे स्वचालित रूप से आपके खाते में सहेजे जाएंगे।",
      resumeBtn: "केस फिर से शुरू करें"
    }
  }
};
...
const TA_DICT: TranslationDictionary = {
  common: {
    ...
    speaking: "பேசுகிறது...",
    footerCommand: "சைபர் ரக்ஷக் 1930 // இரட்டை-இயந்திர குடிமக்கள் சைபர் கட்டளை",
    footerCompliance: "DPDP சட்டம் 2023 இணக்கம் • சாதனத்தில் கிரிப்டோகிராஃபிக் ஹாஷிங் • பிரிவு 63 BSA சான்றளிக்கப்பட்டது",
    step: "படி",
  ...
  intake: {
    ...
    pasteSmsPlaceholder: "டெபிட் செய்தியை ஒட்டவும் e.g. 'Debited Rs 85,500.00 via UPI Ref 312345678901 to VPA ramesh.traders@okaxis...'",
    utrLabel: "12-இலக்க வங்கி UTR / RRN",
    amountLabel: "மோசடி தொகை",
    serverVerified: "சர்வர் சரிபார்க்கப்பட்டது"
  },
  audit: {
    ...
    suspectIfscLabel: "சந்தேகத்திற்கிடமான IFSC குறியீடு",
    victimBankLabel: "பாதிக்கப்பட்டவரின் வங்கி பெயர்",
    victimAccountNoLabel: "பாதிக்கப்பட்டவரின் கணக்கு எண்",
    victimIfscLabel: "பாதிக்கப்பட்டவரின் IFSC குறியீடு",
    ...
    vectorRbiDetails: "மூன்றாம் தரப்பு மீறல்களில் வாடிக்கையாளருக்கு இழப்பீடு இன்றி RBI விதி DPSS.CO.PD.No.1417/02.14.006/2017-18 அமலாக்கம்.",
    noticeCyberSafetyTitle: "சைபர் பாதுகாப்பு நடவடிக்கை பற்றிய அறிவிப்பு",
    noticeCyberSafetyDesc: "உருவாக்கப்பட்ட ஆவணங்கள் இந்திய சைபர் குற்ற ஒருங்கிணைப்பு மையத்தின் (I4C) வழிகாட்டுதல்களின்படி உள்ளன. இவற்றை வங்கி அல்லது 1930 உதவி எண்ணில் சமர்ப்பிக்கலாம்.",
  ...
  step3Action: {
    ...
    whatNextTitle: "அடுத்து நீங்கள் என்ன செய்ய வேண்டும்? (பரிந்துரைக்கப்பட்ட அடுத்த படிகள்)",
  ...
  digitalArrest: {
    ...
    step3NextStepsSubtitle: "உங்களை மிரட்டும் மோசடி செய்பவர்களுக்கு எந்த சட்ட அதிகாரமும் இல்லை. இந்த 3 பாதுகாப்பு படிகளைப் பின்பற்றி உங்கள் அதிகாரப்பூர்வ புகாரைப் பதிவு செய்யவும்.",
    safetyStep1Title: "1. வீடியோ அழைப்புகளைத் துண்டித்து எண்ணைத் தடுக்கவும்",
    safetyStep1Desc: "வாட்ஸ்அப் அல்லது ஸ்கைப் வீடியோ அழைப்புகளை உடனடியாக முடிக்கவும். உண்மையான சட்ட அமலாக்கத்தினர் ஒருபோதும் வெப்கேமில் மிரட்டுவதில்லை.",
    ...
    officialHelplinesTitle: "அதிகாரப்பூர்வ சரிபார்க்கப்பட்ட உதவி எண்கள்",
    nationalCyberHelpline: "தேசிய சைபர்கிரைம் உதவி எண்:",
    tollFree: "1930 (கட்டணமில்லா எண்)",
    citizenCyberDefense: "24x7 குடிமக்கள் சைபர் பாதுகாப்பு",
    cbiControlRoom: "சிபிஐ கட்டுப்பாட்டு அறை:",
    cbiAddress: "தலைமையகம் லோதி சாலை, புது தில்லி",
    edControlRoom: "அமலாக்க இயக்குநரகம் (ED):",
    edAddress: "தலைமையகம், புது தில்லி",
    backToLegalReality: "சட்ட யதார்த்தத்திற்குத் திரும்பு",
    downloadSec63BsaCert: "பிரிவு 63 BSA சான்றிதழைப் பதிவிறக்கவும்",
    bns204_308Tag: "BNS பிரிவு 204 & 308",
    dotSancharSaathiTag: "DoT சஞ்சார் சாதி",
    listenFactCheckAloud: "உண்மை சரிபார்ப்பைக் கேளுங்கள்"
  },
  actions: {
  ...
  modals: {
    auth: {
      loginTitle: "உங்கள் சேமிக்கப்பட்ட வழக்குகளை அணுகவும்",
      registerTitle: "குடிமக்கள் கணக்கை உருவாக்கவும்",
      subtitle: "அனைத்து ஸ்கிரீன்ஷாட்கள் மற்றும் வங்கி பதிவுகள் இந்த கணக்குடன் இணைக்கப்படும்",
      demoAvailable: "டெமோ கணக்கு கிடைக்கிறது",
      fillCredentials: "விவரங்களை நிரப்பவும்",
      fullNameLabel: "முழு பெயர்",
      phoneLabel: "மொபைல் எண்",
      passwordLabel: "கடவுச்சொல்",
      verifying: "சரிபார்க்கிறது...",
      createAccountBtn: "கணக்கை உருவாக்கி அமர்வைச் சேமிக்கவும்",
      loginBtn: "உள்நுழைந்து வழக்கு அமர்வுகளை இணைக்கவும்",
      alreadyHaveAccount: "ஏற்கனவே கணக்கு உள்ளதா?",
      needNewAccount: "புதிய கணக்கு தேவையா?",
      signIn: "உள்நுழைக",
      register: "பதிவு"
    },
    covertMerge: {
      title: "சேமிக்கப்படாத இரகசியக் குறிப்புகள் கண்டறியப்பட்டன",
      subtitle: "அவசர அமர்வின் போது இந்த சாதனத்தில் எடுக்கப்பட்ட குறிப்புகள்",
      prompt: "இந்த சாதனத்தில் எடுக்கப்பட்ட குறிப்புகள் கண்டறியப்பட்டுள்ளன. அவற்றை உங்கள் புதிய அதிகாரப்பூர்வ வழக்கில் இணைக்க விரும்புகிறீர்களா?",
      discardBtn: "குறிப்புகளை நிராகரி",
      importBtn: "இறக்குமதி செய்து வழக்கை தொடங்குங்கள்",
      digitalArrestOption: "மிரட்டிப் பறித்தல் / டிஜிட்டல் கைது",
      digitalArrestSub: "போலி வீடியோ அழைப்புகள் & மிரட்டல்",
      financialOption: "நிதி சைபர் திருட்டு",
      financialSub: "UPI, வங்கி, அட்டை மோசடி"
    },
    savedCases: {
      title: "உங்கள் இணைக்கப்பட்ட வழக்குகள்",
      subtitle: "உங்கள் தொலைபேசி கணக்கின் கீழ் தரவுத்தளத்தில் சேமிக்கப்பட்டுள்ளது",
      loading: "தரவுத்தளத்திலிருந்து உங்கள் அமர்வுகள் ஏற்றப்படுகின்றன...",
      emptyTitle: "இதுவரை முந்தைய வழக்குகள் எதுவும் பதிவு செய்யப்படவில்லை.",
      emptyDesc: "நீங்கள் விவரங்களை உள்ளிடும்போது அல்லது ஸ்கிரீன்ஷாட்களைப் பதிவேற்றும்போது, அவை தானாகவே உங்கள் கணக்கில் சேமிக்கப்படும்.",
      resumeBtn: "வழக்கைத் தொடரவும்"
    }
  }
};
...
const KN_DICT: TranslationDictionary = {
  common: {
    ...
    footerCommand: "ಸೈಬರ್ ರಕ್ಷಕ್ 1930 // ಡ್ಯುಯಲ್-ಎಂಜಿನ್ ನಾಗರಿಕ ಸೈಬರ್ ಕಮಾಂಡ್",
    footerCompliance: "DPDP ಕಾಯ್ದೆ 2023 ಅನುಸರಣೆ • ಸಾಧನದಲ್ಲಿ ಕ್ರಿಪ್ಟೋಗ್ರಾಫಿಕ್ ಹ್ಯಾಶಿಂಗ್ • ಸೆಕ್ಷನ್ 63 BSA ಪ್ರಮಾಣೀಕರಿಸಲಾಗಿದೆ",
    step: "ಹಂತ",
    ...
    digitalCardSubtitle: "ನಕಲಿ ಕಾನೂನು ಜಾರಿ ಕರೆಗಳು, ಬ್ಲ್ಯಾಕ್‌ಮೇಲ್ ಅಥವಾ ಡಿಜಿಟಲ್ ಬಂಧನ ಬೆದರಿಕೆಗಳು",
    digitalCardDesc: "ಕರೆ ಮಾಡುವವರ ವಿವರಗಳು ಮತ್ತು ಸಂದೇಶಗಳನ್ನು ಉಳಿಸಿ. ಸುರಕ್ಷಿತ ವರದಿ ಹಂತಗಳಲ್ಲಿ ನಾವು ನಿಮಗೆ ಮಾರ್ಗದರ್ಶನ ನೀಡುತ್ತೇವೆ.",
    digitalTag1: "ದಾಖಲೆ ಪರಿಶೀಲನೆ",
    digitalTag2: "ದೂರು ಕರಡು",
    digitalTag3: "ಸಿಮ್ ನಿರ್ಬಂಧ ಮಾರ್ಗದರ್ಶನ",
    readDetailsAloud: "ವಿವರಗಳನ್ನು ಗಟ್ಟಿಯಾಗಿ ಓದಿ",
    stopAudio: "ಆಡಿಯೋ ನಿಲ್ಲಿಸಿ"
  },
  navigation: {
    financialStep1: "1. ಏನಾಯಿತು ಎಂದು ತಿಳಿಸಿ",
    financialStep2: "2. ವಿವರಗಳನ್ನು ಪರಿಶೀಲಿಸಿ",
    financialStep3: "3. ಈಗ ಸಹಾಯ ಪಡೆಯಿರಿ",
    digitalArrestStep1: "1. ಏನಾಯಿತು ಎಂದು ತಿಳಿಸಿ",
    digitalArrestStep2: "2. ಸಾಕ್ಷ್ಯ ಪರಿಶೀಲಿಸಿ",
    digitalArrestStep3: "3. ಕ್ರಮ ಕೈಗೊಳ್ಳಿ"
  },
  factCheck: {
    title: "ಕಾನೂನು ಸತ್ಯ ಪರಿಶೀಲನೆ: ನಿಮ್ಮ ಹಕ್ಕುಗಳನ್ನು ತಿಳಿಯಿರಿ",
    subtitle: "ನೈಜ ಭಾರತೀಯ ಕ್ರಿಮಿನಲ್ ಪ್ರಕ್ರಿಯೆ (BNSS) vs ನಕಲಿ ಪೊಲೀಸ್ ಬೆದರಿಕೆಗಳು",
    myth1Title: "ತಪ್ಪು ಕಲ್ಪನೆ: 'ನೀವು ವೀಡಿಯೊ ಕರೆಯಲ್ಲಿ ಡಿಜಿಟಲ್ ಬಂಧನದಲ್ಲಿದ್ದೀರಿ'",
    myth1Reality: "ವಾಸ್ತವ: ಭಾರತೀಯ ಕಾನೂನಿನಲ್ಲಿ (BNS/BNSS) 'ಡಿಜಿಟಲ್ ಬಂಧನ'ಕ್ಕೆ ಯಾವುದೇ ಅವಕಾಶವಿಲ್ಲ. ಪೊಲೀಸರು ಸ್ಕೈಪ್ ಅಥವಾ ವಾಟ್ಸಾಪ್ ಮೂಲಕ ನಾಗರಿಕರನ್ನು ಬಂಧಿಸುವುದಿಲ್ಲ.",
    myth2Title: "ತಪ್ಪು ಕಲ್ಪನೆ: 'ಪರಿಶೀಲನೆಗಾಗಿ RBI ಖಾತೆಗೆ ಹಣ ವರ್ಗಾಯಿಸಿ'",
    myth2Reality: "ವಾಸ್ತವ: RBI ಅಥವಾ ಪೊಲೀಸರು ಎಂದಿಗೂ ಪರಿಶೀಲನೆಗಾಗಿ ಹಣ ವರ್ಗಾವಣೆ ಕೇಳುವುದಿಲ್ಲ. ಹಣದ ಯಾವುದೇ ಬೇಡಿಕೆ 100% ಸುಲಿಗೆಯಾಗಿದೆ.",
    myth3Title: "ತಪ್ಪು ಕಲ್ಪನೆ: 'ಸುಪ್ರೀಂ ಕೋರ್ಟ್ ತಕ್ಷಣದ ಬಂಧನ ವಾರಂಟ್ ನೀಡಿದೆ'",
    myth3Reality: "ವಾಸ್ತವ: ಬಂಧನ ವಾರಂಟ್‌ಗಳನ್ನು ಸ್ಥಳೀಯ ಪೊಲೀಸರು ಖುದ್ದಾಗಿ ನೀಡುತ್ತಾರೆ, ವಾಟ್ಸಾಪ್ ಪಿಡಿಎಫ್ ರೂಪದಲ್ಲಿ ಕಳುಹಿಸುವುದಿಲ್ಲ."
  },
  intake: {
    financialTitle: "ನಿಮ್ಮ ವಹಿವಾಟು ವಿವರಗಳನ್ನು ಸುರಕ್ಷಿತಗೊಳಿಸೋಣ",
    financialSubtitle: "ನಿಮ್ಮ ಬ್ಯಾಂಕ್ ಡೆಬಿಟ್ SMS ಅಥವಾ UPI ರಶೀದಿಯ ಸ್ಕ್ರೀನ್‌ಶಾಟ್ ಅಪ್‌ಲೋಡ್ ಮಾಡಿ ಅಥವಾ ಕೆಳಗೆ ಪಠ್ಯವನ್ನು ಅಂಟಿಸಿ.",
    ...
    pasteSmsPlaceholder: "ಡೆಬಿಟ್ ಸಂದೇಶವನ್ನು ಅಂಟಿಸಿ e.g. 'Debited Rs 85,500.00 via UPI Ref 312345678901 to VPA ramesh.traders@okaxis...'",
    utrLabel: "12-ಅಂಕಿಯ ಬ್ಯಾಂಕಿಂಗ್ UTR / RRN",
    amountLabel: "ವಂಚನೆಯ ಮೊತ್ತ",
    serverVerified: "ಸರ್ವರ್ ಪರಿಶೀಲಿಸಲಾಗಿದೆ"
  },
  audit: {
    scoreLabel: "ಸ್ಕೋರ್",
    detailsChecked: "ವಿವರಗಳನ್ನು ಪರಿಶೀಲಿಸಲಾಗಿದೆ",
    summaryTitle: "ಘಟನೆಯ ಸಾರಾಂಶ ಮತ್ತು ಪುರಾವೆ",
    summaryVerdict: "ತುರ್ತು ಘಟನೆಯ ಡೇಟಾ ಪರಿಶೀಲಿಸಲಾಗಿದೆ. ಬ್ಯಾಂಕ್ ಲಿಯನ್ ಫ್ರೀಜ್ ನೋಟಿಸ್ ಮತ್ತು ಪೊಲೀಸ್ ಎಫ್‌ಐಆರ್ ಸಿದ್ಧವಾಗಿವೆ.",
    recoveryEligibility: "ಮರುಪಡೆಯುವಿಕೆ ಅರ್ಹತೆ",
    eligibleForBankFreeze: "ಬ್ಯಾಂಕ್ ಫ್ರೀಜ್‌ಗೆ ಅರ್ಹವಾಗಿದೆ",
    verifyEditTitle: "ಘಟನೆ ವಿವರಗಳನ್ನು ಪರಿಶೀಲಿಸಿ ಮತ್ತು ಸಂಪಾದಿಸಿ",
    ...
    vectorGoldenHourLabel: "ಸುವರ್ಣ 2-ಗಂಟೆಗಳ ಮರುಪಡೆಯುವಿಕೆ ಸಮಯ",
    vectorGoldenHourPassed: "ಸುವರ್ಣ ಸಮಯದಲ್ಲಿ ವರದಿ ಮಾಡಲಾಗಿದೆ. ಹಣವನ್ನು ನಿರ್ಬಂಧಿಸುವ ಹೆಚ್ಚಿನ ಸಂಭವನೀಯತೆ (>80%).",
    vectorGoldenHourWarning: "ತಡವಾಗಿ ವರದಿ ಮಾಡಲಾಗಿದೆ. ಲಿಯನ್ ವಿನಂತಿಯು ಮ್ಯೂಲ್ ಖಾತೆಗಳನ್ನು ಗುರಿಯಾಗಿಸುತ್ತದೆ.",
    vectorSuspectLabel: "ಮ್ಯೂಲ್ ಖಾತೆ ಮತ್ತು VPA ಟೆಲಿಮೆಟ್ರಿ",
    vectorSuspectPassed: "ಗುರಿ VPA / ಖಾತೆಯನ್ನು ಗುರುತಿಸಲಾಗಿದೆ",
    vectorSuspectWarning: "VPA ವಿವರಗಳು ಅಪೂರ್ಣ; ಬ್ಯಾಂಕ್ UTR ಮೂಲಕ ಪತ್ತೆ ಮಾಡುತ್ತದೆ.",
    vectorRbiLabel: "RBI ಶಾಸನಬದ್ಧ ಶೂನ್ಯ-ಹೊಣೆಗಾರಿಕೆ ನಿಯಮ",
    vectorRbiDetails: "ಗ್ರಾಹಕರ ನಷ್ಟವಿಲ್ಲದೆ RBI ಮಾಸ್ಟರ್ ನಿರ್ದೇಶನ DPSS.CO.PD.No.1417/02.14.006/2017-18 ಜಾರಿ.",
    noticeCyberSafetyTitle: "ಸೈಬರ್ ಸುರಕ್ಷತಾ ಕ್ರಮದ ಕುರಿತು ಸೂಚನೆ",
    noticeCyberSafetyDesc: "ರಚಿಸಲಾದ ದಾಖಲೆಗಳು ಭಾರತೀಯ ಸೈಬರ್ ಕ್ರೈಮ್ ಸಮನ್ವಯ ಕೇಂದ್ರದ (I4C) ಮಾರ್ಗಸೂಚಿಗಳಿಗೆ ಅನುಗುಣವಾಗಿವೆ.",
    backToIntake: "ಇನ್‌ಟೇಕ್‌ಗೆ ಹಿಂತಿರುಗಿ",
    continueToGetHelp: "ಸಹಾಯ ಪಡೆಯಲು ಮುಂದುವರಿಯಿರಿ"
  },
  step3Action: {
    targetAmountLabel: "ಮರುಪಡೆಯುವಿಕೆಗಾಗಿ ಗುರಿ ವಂಚನೆ ಮೊತ್ತ",
    ...
    openFirGuideBtn: "ಸಂಪೂರ್ಣ FIR ಮಾರ್ಗದರ್ಶಿಯನ್ನು ತೆರೆಯಿರಿ",
    noticeInspectorTag: "ನೋಟಿಸ್ ಇನ್‌ಸ್ಪೆಕ್ಟರ್",
    bankNoticeTitle: "ಬ್ಯಾಂಕ್ ನೋಡಲ್ ಇಮೇಲ್ ಇನ್‌ಸ್ಪೆಕ್ಟರ್",
    bankNoticeDesc: "ಸೆಕ್ಷನ್ 91 BNSS ಕಾನೂನು ಪಠ್ಯವನ್ನು ಪರಿಶೀಲಿಸಿ ಮತ್ತು ನೋಡಲ್ ಅಧಿಕಾರಿಗಳ ಸಂಖ್ಯೆಗಳನ್ನು ವೀಕ್ಷಿಸಿ.",
    inspectBankNoticeBtn: "ಸಂಪೂರ್ಣ ಬ್ಯಾಂಕ್ ನೋಟಿಸ್ ವೀಕ್ಷಿಸಿ",
    recoveryRoadmapTitle: "ನಿಮ್ಮ ಹಣ ಹೇಗೆ ಮರಳಿ ಬರುತ್ತದೆ (ಹಂತ-ಹಂತವಾಗಿ)",
    stage1Title: "1930 ಸಹಾಯವಾಣಿಗೆ ವರದಿ ಮಾಡಿ",
    stage1Time: "ಮೊದಲ 15 ನಿಮಿಷಗಳು",
    stage1Desc: "ನಿಮ್ಮ ವಹಿವಾಟಿನ UTR ಅನ್ನು ಫ್ಲ್ಯಾಗ್ ಮಾಡಲು ರಾಷ್ಟ್ರೀಯ ಸೈಬರ್ ಕ್ರೈಮ್ ಪೋರ್ಟಲ್‌ನಲ್ಲಿ ತುರ್ತು ಟಿಕೆಟ್ ನೋಂದಾಯಿಸಲಾಗಿದೆ.",
    stage2Title: "ಸ್ವೀಕರಿಸುವವರ ಬ್ಯಾಂಕ್ ಖಾತೆಯನ್ನು ಫ್ರೀಜ್ ಮಾಡಿ",
    stage2Time: "15 ನಿಮಿಷ – 2 ಗಂಟೆ",
    stage2Desc: "ಹಣವನ್ನು ಹಿಂಪಡೆಯುವ ಮೊದಲು ಲಾಕ್ ಮಾಡಲು ವಂಚಕನ ಬ್ಯಾಂಕ್‌ಗೆ ತುರ್ತು ನೋಟಿಸ್ ಕಳುಹಿಸಲಾಗುತ್ತದೆ.",
    stage3Title: "ಪೊಲೀಸ್ ಸೈಬರ್ FIR ದಾಖಲಿಸಿ",
    stage3Time: "ದಿನ 1 – 5",
    stage3Desc: "ತಡೆಹಿಡಿಯಲಾದ ಹಣವನ್ನು ಕಾನೂನುಬದ್ಧವಾಗಿ ವಶಪಡಿಸಿಕೊಳ್ಳಲು ದೂರನ್ನು ಅಧಿಕೃತ ಎಫ್‌ಐಆರ್ ಆಗಿ ಪರಿವರ್ತಿಸಲಾಗುತ್ತದೆ.",
    stage4Title: "ನಿಮ್ಮ ಖಾತೆಗೆ ಹಣ ಮರುಪಾವತಿ",
    stage4Time: "ದಿನ 7 – 15",
    stage4Desc: "ನ್ಯಾಯಾಲಯ ಅಥವಾ ಬ್ಯಾಂಕ್ ಹಣವನ್ನು ನಿಮ್ಮ ಬ್ಯಾಂಕ್ ಖಾತೆಗೆ ಹಿಂತಿರುಗಿಸಲು ಆದೇಶ ನೀಡುತ್ತದೆ.",
    ...
    whatNextTitle: "ಮುಂದೆ ನೀವು ಏನು ಮಾಡಬೇಕು? (ಶಿಫಾರಸು ಮಾಡಿದ ಮುಂದಿನ ಹಂತಗಳು)",
    nextStep1Title: "ಶಾಂತರಾಗಿರಿ ಮತ್ತು ಕರೆಯನ್ನು ಕಡಿತಗೊಳಿಸಿ",
    nextStep1Desc: "ಗಾಬರಿಯಾಗಬೇಡಿ ಅಥವಾ ವಂಚಕರೊಂದಿಗೆ ಮಾತನಾಡಬೇಡಿ. ಹಣ ಮರಳಿ ಪಡೆಯಲು ಯಾವುದೇ ಶುಲ್ಕವನ್ನು ಪಾವತಿಸಬೇಡಿ.",
    ...
    nextStep3Title: "ನಿಮ್ಮ ಬ್ಯಾಂಕ್ ಶಾಖೆಗೆ ಭೇಟಿ ನೀಡಿ",
    nextStep3Desc: "24-48 ಗಂಟೆಗಳ ಒಳಗೆ ಬ್ಯಾಂಕ್ ಲಿಯನ್ ಪತ್ರದ ಪ್ರತಿಯೊಂದಿಗೆ ನಿಮ್ಮ ಬ್ಯಾಂಕ್ ಮ್ಯಾನೇಜರ್ ಅನ್ನು ಭೇಟಿ ಮಾಡಿ.",
    nextStep4Title: "ರಶೀದಿಗಳನ್ನು ಇರಿಸಿಕೊಳ್ಳಿ ಮತ್ತು ಪೊಲೀಸರನ್ನು ಭೇಟಿ ಮಾಡಿ",
    nextStep4Desc: "1930 / cybercrime.gov.in ನಿಂದ ಬರುವ SMS ಸ್ವೀಕೃತಿಗಳನ್ನು ಉಳಿಸಿ.",
    rememberTitle: "ನೆನಪಿಡಿ:",
    rememberDesc: "ನಿಜವಾದ ಪೊಲೀಸ್ ಅಧಿಕಾರಿಗಳು ಅಥವಾ ಬ್ಯಾಂಕ್ ಉದ್ಯೋಗಿಗಳು ಎಂದಿಗೂ ನಿಮ್ಮ OTP, PIN ಅಥವಾ ಹಣ ವರ್ಗಾವಣೆ ಕೇಳುವುದಿಲ್ಲ."
  },
  digitalArrest: {
    heroTitle: "ನಕಲಿ ಡಿಜಿಟಲ್ ಬಂಧನ ಮತ್ತು ಪೊಲೀಸ್ ವಂಚನೆ ರಕ್ಷಣೆ",
    heroSubtitle: "ನಕಲಿ ಸಿಬಿಐ, ಸೈಬರ್ ಸೆಲ್, ಕಸ್ಟಮ್ಸ್ ಫೆಡೆಕ್ಸ್ ಪಾರ್ಸೆಲ್ ಮತ್ತು ವೀಡಿಯೊ ಕರೆ ಬ್ಲ್ಯಾಕ್‌ಮೇಲ್ ವಿರುದ್ಧ ತಕ್ಷಣದ ಪರಿಹಾರ.",
    impersonatedAgencyLabel: "ನಕಲಿ ಸಂಸ್ಥೆ / ಅಧಿಕಾರಿ",
    callerIdLabel: "ಕರೆ ಮಾಡುವವರ ID / ವಾಟ್ಸಾಪ್ / ಸ್ಕೈಪ್",
    extortionDemandLabel: "ಸುಲಿಗೆ ಬೇಡಿಕೆ ಮೊತ್ತ (₹)",
    disconnectAdviceTitle: "ತಕ್ಷಣದ ಕ್ರಮ: ಕರೆಯನ್ನು ತಕ್ಷಣ ಕಡಿತಗೊಳಿಸಿ",
    disconnectAdviceDesc: "ನೀವು ಸಂಪೂರ್ಣವಾಗಿ ಸುರಕ್ಷಿತವಾಗಿದ್ದೀರಿ. ನಿಜವಾದ ಪೊಲೀಸರು ವೀಡಿಯೊ ಕರೆಯಲ್ಲಿ ಹಣ ಕೇಳುವುದಿಲ್ಲ.",
    factCheckBadge: "ಕಾನೂನು ಸತ್ಯ ಪರಿಶೀಲನೆ & ವಾಸ್ತವ",
    notInDangerBadge: "ನೀವು ಯಾವುದೇ ಕಾನೂನು ಅಪಾಯದಲ್ಲಿಲ್ಲ",
    step2Title: "ಡಿಜಿಟಲ್ ಬಂಧನದ ಹಿಂದಿನ ಸತ್ಯಗಳು & ಕಾನೂನು ವಾಸ್ತವ",
    ...
    claimVsRealityTitle: "ವಂಚಕರ ಹಕ್ಕುಗಳು vs ನೈಜ ಕಾನೂನು ಹಕ್ಕುಗಳು",
    scammerClaimLabel: "ವಂಚಕನ ಬೆದರಿಕೆ",
    legalRealityLabel: "ಕಾನೂನು ವಾಸ್ತವ",
    myth1Claim: "ನೀವು 'ಡಿಜಿಟಲ್ ಬಂಧನ'ದಲ್ಲಿದ್ದೀರಿ ಮತ್ತು ಕೊಠಡಿಯನ್ನು ಬಿಡುವಂತಿಲ್ಲ.",
    myth1Truth: "ಭಾರತೀಯ ಕಾನೂನಿನಲ್ಲಿ 'ಡಿಜಿಟಲ್ ಬಂಧನ'ಕ್ಕೆ 0% ಮಾನ್ಯತೆ ಇದೆ. ವೀಡಿಯೊ ಕರೆಯಲ್ಲಿ ಯಾರನ್ನೂ ಬಂಧಿಸಲು ಸಾಧ್ಯವಿಲ್ಲ.",
    myth2Claim: "24x7 ವೀಡಿಯೊ ಕ್ಯಾಮೆರಾವನ್ನು ಆನ್‌ನಲ್ಲಿಡಿ ಇಲ್ಲದಿದ್ದರೆ ಪೊಲೀಸರು ದಾಳಿ ಮಾಡುತ್ತಾರೆ.",
    myth2Truth: "ಸಮನ್ಸ್‌ಗಳನ್ನು ಲಿಖಿತವಾಗಿ ಖುದ್ದಾಗಿ ನೀಡಬೇಕು. ವೀಡಿಯೊ ಕರೆಯಲ್ಲಿ ಬಂಧಿಸುವುದು ಕ್ರಿಮಿನಲ್ ಸುಲಿಗೆಯಾಗಿದೆ.",
    myth3Claim: "ಪರಿಶೀಲನೆಗಾಗಿ 'RBI ಭದ್ರತಾ ಎಸ್ಕ್ರೋ' ಖಾತೆಗೆ ಹಣ ವರ್ಗಾಯಿಸಿ.",
    myth3Truth: "ಯಾವುದೇ ನ್ಯಾಯಾಲಯ, ಪೊಲೀಸ್ ಅಥವಾ RBI ನಾಗರಿಕರಿಗೆ ಹಣ ವರ್ಗಾವಣೆ ಮಾಡಲು ಹೇಳುವುದಿಲ್ಲ.",
    myth4Claim: "ರಾಷ್ಟ್ರೀಯ ಭದ್ರತಾ ಗೌಪ್ಯತೆ: ಕುಟುಂಬ ಅಥವಾ ವಕೀಲರನ್ನು ಸಂಪರ್ಕಿಸಬೇಡಿ.",
    myth4Truth: "ಸಂವಿಧಾನದ 22ನೇ ವಿಧಿಯ ಅಡಿಯಲ್ಲಿ ವಕೀಲರನ್ನು ಸಂಪರ್ಕಿಸುವುದು ನಾಗರಿಕರ ಮೂಲಭೂತ ಹಕ್ಕು.",
    safeTakeActionBadge: "ನೀವು ಸುರಕ್ಷಿತವಾಗಿದ್ದೀರಿ. ಕೆಳಗೆ ಕ್ರಮ ಕೈಗೊಳ್ಳಿ.",
    step3NextStepsTitle: "ಶಿಫಾರಸು ಮಾಡಿದ ಮುಂದಿನ ಹಂತಗಳು",
    step3NextStepsSubtitle: "ನಿಮ್ಮನ್ನು ಬೆದರಿಸುವ ವಂಚಕರಿಗೆ ಯಾವುದೇ ಕಾನೂನು ಅಧಿಕಾರವಿಲ್ಲ. ಈ 3 ಸುರಕ್ಷತಾ ಕ್ರಮಗಳನ್ನು ಅನುಸರಿಸಿ ಅಧಿಕೃತ ವರದಿ ದಾಖಲಿಸಿ.",
    safetyStep1Title: "1. ಎಲ್ಲಾ ವೀಡಿಯೊ ಕರೆಗಳನ್ನು ಕಡಿತಗೊಳಿಸಿ ಮತ್ತು ನಿರ್ಬಂಧಿಸಿ",
    safetyStep1Desc: "ವಾಟ್ಸಾಪ್ ಅಥವಾ ಸ್ಕೈಪ್ ವೀಡಿಯೊ ಕರೆಗಳನ್ನು ತಕ್ಷಣ ಕೊನೆಗೊಳಿಸಿ. ನಿಜವಾದ ಕಾನೂನು ಜಾರಿ ಸಿಬ್ಬಂದಿ ವೆಬ್‌ಕ್ಯಾಮ್‌ನಲ್ಲಿ ನಾಗರಿಕರನ್ನು ಬೆದರಿಸುವುದಿಲ್ಲ.",
    safetyStep2Title: "2. ಚಕ್ಷು (DoT) ನಲ್ಲಿ ನಕಲಿ ಸಂಖ್ಯೆಯನ್ನು ವರದಿ ಮಾಡಿ",
    safetyStep2Desc: "ಭಾರತದಾದ್ಯಂತ ಸಿಮ್ ಮತ್ತು ಮೊಬೈಲ್ ನಿರ್ಬಂಧಿಸಲು ದೂರಸಂಪರ್ಕ ಇಲಾಖೆಯ ಚಕ್ಷು ಪೋರ್ಟಲ್‌ನಲ್ಲಿ ದೂರು ನೀಡಿ.",
    copyChakshuBtn: "1. ವಂಚಕನ ವಿವರಗಳನ್ನು ನಕಲಿಸಿ",
    chakshuCopiedBtn: "ವಿವರಗಳನ್ನು ನಕಲಿಸಲಾಗಿದೆ!",
    openChakshuBtn: "2. ಸಂಚಾರ್ ಸಾಥಿ (ಚಕ್ಷು) ತೆರೆಯಿರಿ",
    safetyStep3Title: "3. ಡಿಜಿಟಲ್ ಬಂಧನ ಪೊಲೀಸ್ ಎಫ್‌ಐಆರ್ ಡೌನ್‌ಲೋಡ್ ಮಾಡಿ",
    safetyStep3Desc: "ಭಾರತೀಯ ನ್ಯಾಯ ಸಂಹಿತೆ (BNS) ಸೆಕ್ಷನ್ 204 ಮತ್ತು ಸೆಕ್ಷನ್ 308 ರ ಅಡಿಯಲ್ಲಿ ಕ್ರಿಮಿನಲ್ ದೂರು ಸಿದ್ಧಪಡಿಸಿ.",
    downloadDigitalFirBtn: "FIR ದೂರು PDF ಡೌನ್‌ಲೋಡ್ ಮಾಡಿ",
    shareDigitalFirBtn: "ವಾಟ್ಸಾಪ್‌ನಲ್ಲಿ FIR ಹಂಚಿಕೊಳ್ಳಿ",
    continueToSafetyBtn: "ಸುರಕ್ಷತಾ ಕ್ರಮಕ್ಕೆ ಮುಂದುವರಿಯಿರಿ",
    callerThreatDetailsTitle: "ಕರೆ ಮಾಡುವವರ ಮತ್ತು ಬೆದರಿಕೆ ವಿವರಗಳು",
    dropNoticeTitle: "ಅನುಮಾನಾಸ್ಪದ ನೋಟಿಸ್ / ಸಮನ್ಸ್ ಚಿತ್ರ ಅಪ್‌ಲೋಡ್ ಮಾಡಿ",
    dropNoticeSubtitle: "ವಾಟ್ಸಾಪ್ ಅಥವಾ ಸ್ಕೈಪ್‌ನಲ್ಲಿ ಸ್ವೀಕರಿಸಿದ ನಕಲಿ ಸಿಬಿಐ/ಪೊಲೀಸ್ ಪತ್ರ ಅಥವಾ ಸ್ಕ್ರೀನ್‌ಶಾಟ್.",
    uploadDocumentBtn: "ದಾಖಲೆ ಅಪ್‌ಲೋಡ್ ಮಾಡಿ",
    pasteDemandTitle: "ಅಥವಾ ಸಂದೇಶ / ಬೇಡಿಕೆ ಪಠ್ಯವನ್ನು ಅಂಟಿಸಿ",
    pasteDemandPlaceholder: "ಬೆದರಿಕೆ ಸಂದೇಶವನ್ನು ಅಂಟಿಸಿ e.g. 'ನೀವು ಸಿಬಿಐ ಡಿಜಿಟಲ್ ಬಂಧನದಲ್ಲಿದ್ದೀರಿ. ಸ್ಕೈಪ್ ಕ್ಯಾಮೆರಾದಲ್ಲಿರಿ ಮತ್ತು ರೂ 2.5 ಲಕ್ಷ ಠೇವಣಿ ಮಾಡಿ...'",
    targetAgencyLabel: "ಗುರಿ ಸಂಸ್ಥೆ",
    demandLabel: "ಬೇಡಿಕೆ",
    advisoryTitle: "ಅಧಿಕೃತ ಸೈಬರ್ ರಕ್ಷಣಾ ಸಲಹೆ:",
    advisoryDesc: "ಭಾರತೀಯ ಕಾನೂನು ಜಾರಿ ಸಂಸ್ಥೆಗಳು (CBI, ರಾಜ್ಯ ಪೊಲೀಸರು, ED, ಕಸ್ಟಮ್ಸ್, ಸುಪ್ರೀಂ ಕೋರ್ಟ್) ಎಂದಿಗೂ ಸ್ಕೈಪ್ ಅಥವಾ ವಾಟ್ಸಾಪ್ ವೀಡಿಯೊ ಕರೆಗಳಲ್ಲಿ ನಾಗರಿಕರನ್ನು ಬಂಧಿಸುವುದಿಲ್ಲ ಮತ್ತು ಯಾವುದೇ ಖಾತೆಗೆ ಹಣವನ್ನು ವರ್ಗಾಯಿಸಲು ಕೇಳುವುದಿಲ್ಲ. ಹಣ ಕಳುಹಿಸಬೇಡಿ.",
    continueToReviewProof: "ಸಾಕ್ಷ್ಯವನ್ನು ಪರಿಶೀಲಿಸಲು ಮುಂದುವರಿಯಿರಿ",
    officialHelplinesTitle: "ಅಧಿಕೃತ ಪರಿಶೀಲಿಸಿದ ಸಹಾಯವಾಣಿಗಳು ಮತ್ತು ಸಂಖ್ಯೆಗಳು",
    nationalCyberHelpline: "ರಾಷ್ಟ್ರೀಯ ಸೈಬರ್ ಅಪರಾಧ ಸಹಾಯವಾಣಿ:",
    tollFree: "1930 (ಟೋಲ್ ಫ್ರೀ)",
    citizenCyberDefense: "24x7 ನಾಗರಿಕ ಸೈಬರ್ ರಕ್ಷಣೆ",
    cbiControlRoom: "CBI ನಿಯಂತ್ರಣ ಕೊಠಡಿ:",
    cbiAddress: "ಪ್ರಧಾನ ಕಚೇರಿ ಲೋಧಿ ರಸ್ತೆ, ನವದೆಹಲಿ",
    edControlRoom: "ಜಾರಿ ನಿರ್ದೇಶನಾಲಯ (ED):",
    edAddress: "ಪ್ರಧಾನ ಕಚೇರಿ, ನವದೆಹಲಿ",
    backToLegalReality: "ಕಾನೂನು ವಾಸ್ತವಕ್ಕೆ ಹಿಂತಿರುಗಿ",
    downloadSec63BsaCert: "ಸೆಕ್ಷನ್ 63 BSA ಪ್ರಮಾಣಪತ್ರವನ್ನು ಡೌನ್‌ಲೋಡ್ ಮಾಡಿ",
    bns204_308Tag: "BNS ಸೆಕ್ಷನ್ 204 & 308",
    dotSancharSaathiTag: "DoT ಸಂಚಾರ್ ಸಾಥಿ",
    listenFactCheckAloud: "ವಾಸ್ತವ ಪರಿಶೀಲನೆಯನ್ನು ಆಲಿಸಿ"
  },
  actions: {
    heroTitle: "ಈಗಲೇ ಕ್ರಮ ಕೈಗೊಳ್ಳಿ — 1-ಟ್ಯಾಪ್ ನೇರ ಲಿಂಕ್‌ಗಳು",
    heroSubtitle: "ಹಸ್ತಚಾಲಿತ ನಕಲು-ಅಂಟಿಸುವಿಕೆ ಇಲ್ಲದೆ ಒಂದೇ ಟ್ಯಾಪ್‌ನಲ್ಲಿ ಎಲ್ಲಾ ತುರ್ತು ಕ್ರಮಗಳನ್ನು ಪ್ರಾರಂಭಿಸಿ.",
    step1HelplineTitle: "1930 ಸಹಾಯವಾಣಿಗೆ ಕರೆ ಮಾಡಿ",
    step1HelplineDesc: "ರಾಷ್ಟ್ರೀಯ ಸೈಬರ್ ಕ್ರೈಮ್ ನಾಗರಿಕ ಸಹಾಯವಾಣಿಗೆ ನೇರ ಸಂಪರ್ಕ.",
    step1HelplineBtn: "ಈಗಲೇ 1930 ಡಯಲ್ ಮಾಡಿ",
    step2BankTitle: "ಬ್ಯಾಂಕ್ ವಂಚನೆ ವಿಭಾಗಕ್ಕೆ ಇಮೇಲ್ ಮಾಡಿ (ಸೆಕ್ಷನ್ 91 BNSS)",
    step2BankDesc: "ಪೂರ್ವ-ರಚಿತ ಶಾಸನಬದ್ಧ ಲಿಯನ್ ವಿನಂತಿ ನೋಟಿಸ್ ಕಳುಹಿಸುತ್ತದೆ:",
    ...
    teleprompterHello: "ನಮಸ್ಕಾರ ಅಧಿಕಾರಿಯವರೇ, ನಾನು ತುರ್ತು ಅನಧಿಕೃತ ಸೈಬರ್ ವಂಚನೆಯನ್ನು ವರದಿ ಮಾಡಬೇಕಾಗಿದೆ, ಮೊತ್ತ ₹",
    teleprompterClosing: "ಸ್ವೀಕರಿಸುವವರ ಖಾತೆಯನ್ನು ಫ್ರೀಜ್ ಮಾಡಲು ದಯವಿಟ್ಟು CFCFRMS ನಲ್ಲಿ ಈ UTR ಅನ್ನು ಫ್ಲ್ಯಾಗ್ ಮಾಡಿ ಮತ್ತು ಸ್ವೀಕೃತಿ ಸಂಖ್ಯೆಯನ್ನು ನೀಡಿ.",
    ...
    emailBankTitle: "ಬ್ಯಾಂಕ್ ವಂಚನೆ ವಿಭಾಗಕ್ಕೆ ಇಮೇಲ್ ಮಾಡಿ (ಸೆಕ್ಷನ್ 91 BNSS)",
    emailBankDesc: "ಪೂರ್ವ-ರಚಿತ ಶಾಸನಬದ್ಧ ಲಿಯನ್ ವಿನಂತಿ ನೋಟಿಸ್ ಕಳುಹಿಸುತ್ತದೆ:",
    ...
    statementCopiedBtn: "ಹೇಳಿಕೆಯನ್ನು ನಕಲಿಸಲಾಗಿದೆ!",
    openPortalBtn: "2. cybercrime.gov.in ತೆರೆಯಿರಿ",
    shareDocsTitle: "1-ಟ್ಯಾಪ್ ವಾಟ್ಸಾಪ್ ಮತ್ತು ದಾಖಲೆ ಹಂಚಿಕೆ (ಕುಟುಂಬ, ವಕೀಲರು, ಪೊಲೀಸರು)",
    shareDocsSubtitle: "ಡಿಜಿಟಲ್ ಸಂಕಲಿಸಿದ ಕಾನೂನು ಪುರಾವೆಗಳ PDFಗಳನ್ನು ನೇರವಾಗಿ ಹಂಚಿಕೊಳ್ಳಿ.",
    ...
    docCourtRefund: "ನ್ಯಾಯಾಲಯ ಮರುಪಾವತಿ",
  ...
  a11y: {
    ...
    sizeExtraLarge: "ಬಹಳ ದೊಡ್ಡದು (1.5x)",
    ...
    readPageAloudTitle: "ಪುಟವನ್ನು ಗಟ್ಟಿಯಾಗಿ ಓದಿ",
    readPageAloudDesc: "ಬ್ರೌಸರ್ ಧ್ವನಿಯ ಮೂಲಕ ಪುಟದ ವಿಷಯವನ್ನು ಆಡಿಯೊ ರೂಪದಲ್ಲಿ ಪ್ಲೇ ಮಾಡುತ್ತದೆ.",
    readBtn: "ಓದಿ",
    stopBtn: "ನಿಲ್ಲಿಸಿ",
    audioFirstTitle: "ಆಡಿಯೋ-ಮೊದಲ ಮೋಡ್ (ಸ್ವಯಂ ಓದುವಿಕೆ)",
    audioFirstDesc: "ಬಟನ್ ಒತ್ತದೆಯೇ ಹೊರತೆಗೆಯಲಾದ ಡೇಟಾ ಮತ್ತು ಕಾನೂನು ಸತ್ಯಗಳನ್ನು ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಮಾತನಾಡುತ್ತದೆ.",
    islTitle: "ಭಾರತೀಯ ಸಂಕೇತ ಭಾಷೆ (ISL)",
    islDesc: "ಮುಖ್ಯ ಹಂತಗಳಲ್ಲಿ ಸಂಕೇತ ಭಾಷೆಯ ವೀಡಿಯೊಗಳನ್ನು ತೋರಿಸುತ್ತದೆ."
  },
  modals: {
    auth: {
      loginTitle: "ನಿಮ್ಮ ಉಳಿಸಿದ ಪ್ರಕರಣಗಳನ್ನು ಪ್ರವೇಶಿಸಿ",
      registerTitle: "ನಾಗರಿಕ ಖಾತೆಯನ್ನು ರಚಿಸಿ",
      subtitle: "ಎಲ್ಲಾ ಸ್ಕ್ರೀನ್‌ಶಾಟ್‌ಗಳು ಮತ್ತು ಬ್ಯಾಂಕ್ ದಾಖಲೆಗಳು ಈ ಖಾತೆಗೆ ಲಿಂಕ್ ಆಗುತ್ತವೆ",
      demoAvailable: "ಡೆಮೊ ಖಾತೆ ಲಭ್ಯವಿದೆ",
      fillCredentials: "ರುಜುವಾತುಗಳನ್ನು ಭರ್ತಿ ಮಾಡಿ",
      fullNameLabel: "ಪೂರ್ಣ ಹೆಸರು",
      phoneLabel: "ಮೊಬೈಲ್ ಸಂಖ್ಯೆ",
      passwordLabel: "ಖಾತೆ ಪಾಸ್‌ವರ್ಡ್",
      verifying: "ಪರಿಶೀಲಿಸಲಾಗುತ್ತಿದೆ...",
      createAccountBtn: "ಖಾತೆಯನ್ನು ರಚಿಸಿ ಮತ್ತು ಸೆಷನ್ ಉಳಿಸಿ",
      loginBtn: "ಲಾಗಿನ್ ಮಾಡಿ ಮತ್ತು ಕೇಸ್ ಸೆಷನ್‌ಗಳನ್ನು ಲಿಂಕ್ ಮಾಡಿ",
      alreadyHaveAccount: "ಈಗಾಗಲೇ ಖಾತೆ ಹೊಂದಿದ್ದೀರಾ?",
      needNewAccount: "ಹೊಸ ಖಾತೆ ಬೇಕೇ?",
      signIn: "ಸೈನ್ ಇನ್",
      register: "ನೋಂದಣಿ"
    },
    covertMerge: {
      title: "ಉಳಿಸದ ರಹಸ್ಯ ಟಿಪ್ಪಣಿಗಳು ಕಂಡುಬಂದಿವೆ",
      subtitle: "ತುರ್ತು ಸೆಷನ್ ಸಮಯದಲ್ಲಿ ಈ ಸಾಧನದಲ್ಲಿ ಸೆರೆಹಿಡಿಯಲಾದ ಟಿಪ್ಪಣಿಗಳು",
      prompt: "ಈ ಸಾಧನದಲ್ಲಿ ಸೆರೆಹಿಡಿಯಲಾದ ಟಿಪ್ಪಣಿಗಳು ಕಂಡುಬಂದಿವೆ. ಅವುಗಳಿಂದ ನೀವು ಹೊಸ ಪ್ರಕರಣವನ್ನು ಪ್ರಾರಂಭಿಸಲು ಬಯಸುವಿರಾ?",
      discardBtn: "ಟಿಪ್ಪಣಿಗಳನ್ನು ತಿರಸ್ಕರಿಸಿ",
      importBtn: "ಆಮದು ಮಾಡಿ ಮತ್ತು ಕೇಸ್ ಪ್ರಾರಂಭಿಸಿ",
      digitalArrestOption: "ಸುಲಿಗೆ / ಡಿಜಿಟಲ್ ಅರೆಸ್ಟ್",
      digitalArrestSub: "ನಕಲಿ ವೀಡಿಯೊ ಕರೆಗಳು ಮತ್ತು ಸುಲಿಗೆ",
      financialOption: "ಹಣಕಾಸು ಸೈಬರ್ ಕಳ್ಳತನ",
      financialSub: "UPI, ಬ್ಯಾಂಕ್, ಕಾರ್ಡ್ ವಂಚನೆ"
    },
    savedCases: {
      title: "ನಿಮ್ಮ ಲಿಂಕ್ ಮಾಡಲಾದ ಪ್ರಕರಣಗಳು",
      subtitle: "ನಿಮ್ಮ ಫೋನ್ ಖಾತೆಯ ಅಡಿಯಲ್ಲಿ ಡೇಟಾಬೇಸ್‌ನಲ್ಲಿ ಸುರಕ್ಷಿತವಾಗಿ ಸಂಗ್ರಹಿಸಲಾಗಿದೆ",
      loading: "ಡೇಟಾಬೇಸ್‌ನಿಂದ ನಿಮ್ಮ ಸೆಷನ್‌ಗಳನ್ನು ಲೋಡ್ ಮಾಡಲಾಗುತ್ತಿದೆ...",
      emptyTitle: "ಇನ್ನೂ ಯಾವುದೇ ಹಿಂದಿನ ಪ್ರಕರಣಗಳು ದಾಖಲಾಗಿಲ್ಲ.",
      emptyDesc: "ನೀವು ವಿವರಗಳನ್ನು ನಮೂದಿಸಿದಾಗ ಅಥವಾ ಸ್ಕ್ರೀನ್‌ಶಾಟ್‌ಗಳನ್ನು ಅಪ್‌ಲೋಡ್ ಮಾಡಿದಾಗ, ಅವು ಸ್ವಯಂಚಾಲಿತವಾಗಿ ನಿಮ್ಮ ಖಾತೆಗೆ ಉಳಿಸಲ್ಪಡುತ್ತವೆ.",
      resumeBtn: "ಪ್ರಕರಣವನ್ನು ಪುನರಾರಂಭಿಸಿ"
    }
  }
};
...
const BN_DICT: TranslationDictionary = {
  common: {
    appName: "CyberRakshak 1930",
    tagline: "নির্দেশিত সাইবার-প্রতারণা সহায়ক ও সংবিধিবদ্ধ ব্যবস্থা",
    ...
    topBannerAlert: "দ্রুত রিপোর্ট করলে টাকা আটকানোর সম্ভাবনা বাড়ে।",
    ...
    verified: "যাচাইকৃত",
    recordLiveCallout: "এখনই কোনো প্রতারণা কলে আছেন? লাইভ রেকর্ড করুন",
    recordLiveBtn: "লাইভ রেকর্ড",
    accessibilityBtn: "অভিগম্যতা",
    voiceGuideBtn: "ভয়েস গাইড",
    speaking: "কথা বলছে...",
    footerCommand: "সাইবার রক্ষক 1930 // ডুয়াল-ইঞ্জিন সিটিজেন সাইবার কমান্ড",
    footerCompliance: "DPDP আইন ২০২৩ অনুগত • ডিভাইসে ক্রিপ্টোগ্রাফিক হ্যাশিং • ধারা ৬৩ BSA প্রত্যয়িত",
    step: "ধাপ",
    flowSelectTitle: "কী ঘটেছে আমাদের বলুন",
    flowSelectSubtitle: "আপনার পরিস্থিতির সাথে সবচেয়ে উপযুক্ত বিকল্পটি বেছে নিন।",
    selected: "নির্বাচিত",
    ...
    financialCardDesc: "আপনার পেমেন্টের বিবরণ যোগ করুন, তারপর আপনার ব্যাঙ্ক ও সাইবার ক্রাইম হেল্পলাইনে যোগাযোগ করুন।",
    ...
    digitalCardDesc: "কলার বিবরণ ও বার্তা সংরক্ষণ করুন। আমরা আপনাকে নিরাপদতম রিপোর্টিং প্রক্রিয়ায় পথ দেখাব।",
    digitalTag1: "নথি পরীক্ষা",
    digitalTag2: "অভিযোগের খসড়া",
    digitalTag3: "সিম ব্লক নির্দেশিকা",
    readDetailsAloud: "বিবরণ জোরে পড়ুন",
    stopAudio: "অডিও থামান"
  },
  navigation: {
    financialStep1: "১. কী ঘটেছে বলুন",
    financialStep2: "২. বিবরণ যাচাই করুন",
    financialStep3: "৩. এখনই সাহায্য পান",
    digitalArrestStep1: "১. কী ঘটেছে বলুন",
    digitalArrestStep2: "২. প্রমাণ দেখুন ও রিপোর্ট করুন",
    digitalArrestStep3: "৩. আইনি পদক্ষেপ নিন"
  },
  factCheck: {
    title: "আইনি তথ্য যাচাই: আপনার অধিকার জানুন",
    subtitle: "প্রকৃত ভারতীয় ফৌজদারি কার্যবিধি (BNSS) বনাম ভুয়া পুলিশ হুমকি",
    myth1Title: "ভ্রান্ত ধারণা: 'আপনি ভিডিও কলে ডিজিটাল অ্যারেস্টে আছেন'",
    myth1Reality: "বাস্তবতা: ভারতীয় আইনে (BNS/BNSS) 'ডিজিটাল অ্যারেস্ট'-এর কোনো বিধান নেই। পুলিশ কখনো স্কাইপ বা হোয়াটসঅ্যাপে গ্রেপ্তার করে না।",
    myth2Title: "ভ্রান্ত ধারণা: 'নির্দোষ প্রমাণ করতে আরবিআই অ্যাকাউন্টে টাকা স্থানান্তর করুন'",
  ...
  intake: {
    ...
    pasteSmsPlaceholder: "ডেবিট বার্তা পেস্ট করুন e.g. 'Debited Rs 85,500.00 via UPI Ref 312345678901 to VPA ramesh.traders@okaxis...'",
    utrLabel: "১২-সংখ্যার ব্যাঙ্কিং UTR / RRN",
    amountLabel: "প্রতারণার পরিমাণ",
    serverVerified: "সার্ভার যাচাইকৃত"
  },
  audit: {
    scoreLabel: "স্কোর",
    ...
    vectorRbiDetails: "গ্রাহকের ক্ষতি ছাড়া আরবিআই মাস্টার ডিরেকশন DPSS.CO.PD.No.1417/02.14.006/2017-18 এর প্রয়োগ।",
  ...
  step3Action: {
    ...
    whatNextTitle: "এরপর আপনার কী করা উচিত? (সুপারিশকৃত পরবর্তী পদক্ষেপ)",
  ...
  digitalArrest: {
    ...
    step3NextStepsSubtitle: "আপনাকে ভয় দেখানোর চেষ্টা করা প্রতারকদের কোনো আইনি ক্ষমতা নেই। এই ৩টি সুরক্ষা পদক্ষেপ অনুসরণ করুন এবং অফিসিয়াল রিপোর্ট জমা দিন।",
    safetyStep1Title: "১. সব ভিডিও কল কেটে দিন এবং কলারকে ব্লক করুন",
    safetyStep1Desc: "হোয়াটসঅ্যাপ বা স্কাইপ ভিডিও কল অবিলম্বে বন্ধ করুন। আসল পুলিশ কখনোই ওয়েবক্যামে ভয় দেখায় না।",
    ...
    openChakshuBtn: "2. সঞ্চার সাথী খুলুন (চক্ষু)",
    safetyStep3Title: "৩. ডিজিটাল অ্যারেস্ট পুলিশ এফআইআর ডাউনলোড ও দায়ের করুন",
    safetyStep3Desc: "ভারতীয় ন্যায় সংহিতা (BNS) ধারা ২০৪ (লোক সেবকের ছদ্মবেশ ধারণ) ও ধারা ৩০৮ (চাঁদাবাজি) এর অধীনে ফৌজদারি অভিযোগ তৈরি করুন।",
    ...
    officialHelplinesTitle: "অফিসিয়াল যাচাইকৃত হেল্পলাইন ও নম্বর",
    nationalCyberHelpline: "জাতীয় সাইবার ক্রাইম হেল্পলাইন:",
    tollFree: "1930 (টোল ফ্রি)",
    citizenCyberDefense: "২৪x৭ নাগরিক সাইবার প্রতিরক্ষা",
    cbiControlRoom: "সিবিআই কন্ট্রোল রুম:",
    cbiAddress: "সদর দফতর লোধি রোড, নতুন দিল্লি",
    edControlRoom: "এনফোর্সমেন্ট ডিরেক্টরেট (ED):",
    edAddress: "সদর দফতর, নতুন দিল্লি",
    backToLegalReality: "আইনি বাস্তবতায় ফিরে যান",
    downloadSec63BsaCert: "ধারা ৬৩ BSA শংসাপত্র ডাউনলোড করুন",
    bns204_308Tag: "BNS ধারা ২০৪ ও ৩০৮",
    dotSancharSaathiTag: "DoT সঞ্চার সাথী",
    listenFactCheckAloud: "তথ্য যাচাই জোরে শুনুন"
  },
  actions: {
  ...
  modals: {
    auth: {
      loginTitle: "আপনার সংরক্ষিত কেসগুলি অ্যাক্সেস করুন",
      registerTitle: "নাগরিক অ্যাকাউন্ট তৈরি করুন",
      subtitle: "সমস্ত স্ক্রিনশট এবং ব্যাঙ্ক রেকর্ড এই অ্যাকাউন্টের সাথে লিঙ্ক করা হয়",
      demoAvailable: "ডেমো অ্যাকাউন্ট উপলব্ধ",
      fillCredentials: "শংসাপত্র পূরণ করুন",
      fullNameLabel: "পুরো নাম",
      phoneLabel: "মোবাইল নম্বর",
      passwordLabel: "পাসওয়ার্ড",
      verifying: "যাচাই করা হচ্ছে...",
      createAccountBtn: "অ্যাকাউন্ট তৈরি করুন এবং সেশন সংরক্ষণ করুন",
      loginBtn: "লগইন করুন এবং কেস সেশন লিঙ্ক করুন",
      alreadyHaveAccount: "ইতিমধ্যে একটি অ্যাকাউন্ট আছে?",
      needNewAccount: "নতুন অ্যাকাউন্ট প্রয়োজন?",
      signIn: "সাইন ইন",
      register: "নিবন্ধন"
    },
    covertMerge: {
      title: "অসংরক্ষিত গোপন নোট পাওয়া গেছে",
      subtitle: "জরুরি সেশনের সময় এই ডিভাইসে ধারণ করা নোট",
      prompt: "এই ডিভাইসে ধারণ করা নোট পাওয়া গেছে। আপনি কি এগুলি দিয়ে একটি নতুন কেস শুরু করতে চান?",
      discardBtn: "নোট বাতিল করুন",
      importBtn: "আমদানি করুন এবং কেস শুরু করুন",
      digitalArrestOption: "চাঁদাবাজি / ডিজিটাল অ্যারেস্ট",
      digitalArrestSub: "ভুয়া ভিডিও কল ও চাঁদাবাজি",
      financialOption: "আর্থিক সাইবার চুরি",
      financialSub: "ইউপিআই, ব্যাঙ্ক, কার্ড প্রতারণা"
    },
    savedCases: {
      title: "আপনার লিঙ্ক করা ঘটনা কেস",
      subtitle: "আপনার ফোন অ্যাকাউন্টের অধীনে ডাটাবেসে স্থায়ীভাবে সংরক্ষিত",
      loading: "ডাটাবেস থেকে আপনার সেশন লোড হচ্ছে...",
      emptyTitle: "এখনও কোনো অতীত কেস রেকর্ড করা হয়নি।",
      emptyDesc: "আপনি যখন ঘটনার বিবরণ লিখবেন বা স্ক্রিনশট আপলোড করবেন, সেগুলি স্বয়ংক্রিয়ভাবে আপনার অ্যাকাউন্টে সংরক্ষিত হবে।",
      resumeBtn: "কেস পুনরায় শুরু করুন"
    }
  }
};
