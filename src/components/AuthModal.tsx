...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="bg-white text-slate-800 border border-slate-200 rounded-2xl shadow-xl max-w-md w-full p-6 sm:p-7 relative font-sans"
        onClick={(e) => e.stopPropagation()}
      >
        <button
          onClick={onClose}
          className="absolute top-5 right-5 w-8 h-8 flex items-center justify-center rounded-lg bg-slate-100 text-slate-500 hover:text-slate-800"
        >
          <X className="w-4 h-4" />
        </button>
        ...
        <div className="bg-indigo-50/70 border border-indigo-100 rounded-xl p-3.5 mb-5 text-xs text-slate-700">
          ...
          <div className="text-[11px] text-slate-600 space-y-0.5">
            <div>Phone: <strong className="text-slate-900 font-mono">9999999999</strong></div>
            <div>Password: <strong className="text-slate-900 font-mono">password123</strong></div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs focus:outline-hidden focus:ring-2 focus:ring-indigo-500"
                />
              </div>
            </div>
          )}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-mono focus:outline-hidden focus:ring-2 focus:ring-indigo-500"
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold text-xs flex items-center justify-center gap-2 shadow-xs transition-all disabled:opacity-50"
          >
