...
export const SignLanguageSlot: React.FC<SignLanguageSlotProps> = ({
  ...
  return (
    <div
      className={`bg-gradient-to-r from-indigo-50/70 via-slate-50 to-emerald-50/50 border border-indigo-100/90 rounded-2xl p-4 sm:p-5 shadow-xs mb-6 ${className}`}
      role="region"
      aria-label="Indian Sign Language video notice"
    >
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 mb-3 pb-2.5 border-b border-indigo-100/60">
        ...
        <span className="inline-flex items-center gap-1 text-[10px] bg-indigo-100/70 text-indigo-800 font-bold px-2.5 py-0.5 rounded-full border border-indigo-200">
      ...
      <div className="space-y-2.5 text-xs text-slate-600">
        ...
        <div className="p-3 bg-white/80 border border-emerald-200/80 rounded-xl flex items-start gap-2.5 text-slate-700 shadow-2xs">
          ...
          <div>
            <strong className="text-[11px] font-bold text-emerald-900 block mb-0.5">
